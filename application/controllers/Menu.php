...
class Menu extends CI_Controller {
    ...
    if ($this->form_validation->run() == false) {
        ...
        $this->session->set_flashdata(
            'message',
            '<div class="alert alert-danger" role="alert"> New Menu Added!
            </div>'
        );
        redirect('menu');
    }
...
$this->session->userdata('email')])->row_array();
    ...
    public function hapus($id)
    {
        ...
        $this->session->set_flashdata(
            'message',
            '<div class="alert alert-danger" role="alert">Sub Menu Deletet</div>'
        );
        redirect('menu/submenu');
    }
    ...
    public function menuedit()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata(
                'message',
                '<div class="alert alert-danger" rolw="alert"> Chabge Failed</div>'
            );
            redirect('menu/index');
        }else {
            $data = array(
