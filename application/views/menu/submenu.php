...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            data-toggle="modal"
            data-target="#subMenuModal">Add Sub Menu</a>
            <!--Tabel-->
                ...
                <tbody>
                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                            <button href="#" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</button>
...
<!--Modal-->
<div class="modal fade" id="subMenuModal" tabindex="1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
            ...
            <form action="<?= base_url('menu/submenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-chek-input" type="checkbox" value="1" name="is_active" id="is_active" aria-label="Checkbox for following text input" checked>
    ...
    <div class="modal-dialog" role ="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/submenuedit/'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" value="<?= $sm['title'] ?>" class="form-control" id="title"
                        name="title" placeholder="Submenu title">
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id"
                        name="id" readonly value="<?= $sm['id'] ?>">
                    </div>
